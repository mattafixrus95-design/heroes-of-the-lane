...
export const CREEP_DEFS: Record<CreepKind, CreepDef> = {
  ...
  wight:        { kind: "wight",        name: "Призрак",       hp:   22, speed: 1.3, regenPerSec:  0, reward:   5, livesLost: 1, abilities: ["dodge"],                emoji: "👻" },
  minotaur:     { kind: "minotaur",     name: "Минотавр",      hp:   25, speed: 0.9, regenPerSec:  0, reward:   5, livesLost: 1, abilities: ["block"],                emoji: "🐂" },
  golem:        { kind: "golem",        name: "Голем",         hp:   35, speed: 0.7, regenPerSec:  0, reward:   6, livesLost: 1, abilities: ["slow_resist"],          emoji: "🗿" },
  // ── Волна 10: T6 ────────────────────────────────────────────────────────
  ...
  crusader:     { kind: "crusader",     name: "Крестоносец",   hp:   40, speed: 1.0, regenPerSec:  0, reward:   7, livesLost: 1, abilities: [],                       emoji: "🐎" },
  vampire_lord: { kind: "vampire_lord", name: "Вампир Лорд",  hp:   45, speed: 1.2, regenPerSec:  0, reward:   8, livesLost: 1, abilities: [],                       emoji: "🌙" },
  pit_lord:     { kind: "pit_lord",     name: "Властелин Ям", hp:   55, speed: 0.9, regenPerSec:  0, reward:  10, livesLost: 1, abilities: [],                       emoji: "👿" },
  roc:          { kind: "roc",          name: "Рок",           hp:   50, speed: 1.0, regenPerSec:  0, reward:   9, livesLost: 1, abilities: [],                       emoji: "🐦" },
  lich:         { kind: "lich",         name: "Лич",           hp:   65, speed: 0.6, regenPerSec:  5, reward:  14, livesLost: 1, abilities: ["block"],                emoji: "☠" },
  devil:        { kind: "devil",        name: "Дьявол",        hp:  130, speed: 1.0, regenPerSec:  0, reward:  27, livesLost: 1, abilities: ["dodge"],                emoji: "🔥" },
  titan:        { kind: "titan",        name: "Титан",         hp:  220, speed: 0.7, regenPerSec:  0, reward:  35, livesLost: 1, abilities: ["slow_resist", "block"], emoji: "⚡" },
  black_dragon: { kind: "black_dragon", name: "Чёрный Дракон",hp:  185, speed: 1.3, regenPerSec:  0, reward:  30, livesLost: 1, abilities: [],                       emoji: "🐉" },
