...
export const CREEP_DEFS: Record<CreepKind, CreepDef> = {
  ...
  golem:        { kind: "golem",        name: "Голем",          hp:   70, speed: 0.7, regenPerSec:  0, reward:   4, livesLost: 1, abilities: ["slow_resist", "root_resist"],        emoji: "🗿" },
  // ── Волна 10: Босс ───────────────────────────────────────────────────────
  angel:        { kind: "angel",        name: "Ангел",          hp: 1250, speed: 0.5, regenPerSec:  3, reward: 100, livesLost: 7, abilities: [],                                    emoji: "😇" },
  // ── Волны 11–19: T4-T7 ───────────────────────────────────────────────────
  ogr:          { kind: "ogr",          name: "Огр",            hp:   70, speed: 0.6, regenPerSec:  0, reward:   4, livesLost: 1, abilities: [],                                    emoji: "👹" },
  crusader:     { kind: "crusader",     name: "Крестоносец",    hp:   80, speed: 1.0, regenPerSec:  0, reward:   5, livesLost: 1, abilities: [],                                    emoji: "🐎" },
  vampire_lord: { kind: "vampire_lord", name: "Вампир Лорд",    hp:   90, speed: 1.2, regenPerSec:  0, reward:   5, livesLost: 1, abilities: [],                                    emoji: "🧛" },
  pit_lord:     { kind: "pit_lord",     name: "Властелин Ям",   hp:  120, speed: 0.9, regenPerSec:  0, reward:   9, livesLost: 1, abilities: [],                                    emoji: "👿" },
  roc:          { kind: "roc",          name: "Рок",            hp:  110, speed: 1.0, regenPerSec:  0, reward:   8, livesLost: 1, abilities: [],                                    emoji: "🦅" },
  lich:         { kind: "lich",         name: "Лич",            hp:  150, speed: 0.6, regenPerSec:  5, reward:  10, livesLost: 1, abilities: ["block"],                             emoji: "☠" },
  devil:        { kind: "devil",        name: "Дьявол",         hp:  250, speed: 1.0, regenPerSec:  0, reward:  13, livesLost: 1, abilities: ["dodge"],                             emoji: "🔥" },
  titan:        { kind: "titan",        name: "Титан",          hp:  350, speed: 0.7, regenPerSec:  0, reward:  20, livesLost: 1, abilities: ["slow_resist", "block"],              emoji: "⚡" },
  black_dragon: { kind: "black_dragon", name: "Чёрный Дракон",  hp:  400, speed: 1.3, regenPerSec:  0, reward:  22, livesLost: 1, abilities: [],                                    emoji: "🐉" },
  // ── Волна 20: Финальный босс ─────────────────────────────────────────────
  archangel:    { kind: "archangel",    name: "Архангел",       hp: 3500, speed: 0.5, regenPerSec: 10, reward: 150, livesLost:10, abilities: ["self_heal"],                         emoji: "🌟" },
};
