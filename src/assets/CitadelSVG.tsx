export default function CitadelSVG({ size = 52 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg">
      {/* Контактная тень */}
      <ellipse cx="26" cy="50" rx="22" ry="2.2" fill="rgba(0,0,0,0.32)"/>

      {/* Боковая грань правой башни — здание развёрнуто "полубоком" */}
      <polygon points="44,20 49,17 49,49 44,52" fill="#8a8a8a"/>
      <line x1="44" y1="26" x2="49" y2="23" stroke="#6b6b6b70" strokeWidth="0.8"/>
      <line x1="44" y1="34" x2="49" y2="31" stroke="#6b6b6b70" strokeWidth="0.8"/>
      <line x1="44" y1="42" x2="49" y2="39" stroke="#6b6b6b70" strokeWidth="0.8"/>
      {/* Скошенный верх правой башни */}
      <polygon points="34,20 44,20 49,17 39,17" fill="#cfcfcf"/>
      ...
      {/* Правая башня (фронт) */}
      <rect x="34" y="20" width="10" height="32" fill="#BDBDBD"/>
      ...
      {/* Зубцы правой башни */}
      <rect x="34" y="14" width="3" height="8" fill="#BDBDBD"/>
      <rect x="39" y="14" width="4" height="8" fill="#BDBDBD"/>
      {/* Зубцы стены */}
      ...
      <line x1="34" y1="26" x2="44" y2="26" stroke="#0004" strokeWidth="0.8"/>
      <line x1="12" y1="34" x2="40" y2="34" stroke="#0003" strokeWidth="0.8"/>

      {/* Окна на башнях */}
      <rect x="8"  y="30" width="5" height="6" fill="#1a1a2e" rx="1"/>
      <rect x="37" y="30" width="4" height="6" fill="#1a1a2e" rx="1"/>
    </svg>
  );
}
